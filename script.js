...
form_vehicle_type: "Vehicle type"
  ...
  hero_title: "Kalaji Automotive",
  hero_subtitle: "تأجير فاخر وتنقل الأعمال",
  hero_button: "عرض التأجير",

  contact_title: "اتصل بنا",
  lease_title: "خيارات التأجير",

  car_person_title: "سيارة ركاب",
  ...
  halal_title: "لماذا التأجير الحلال؟",
...
window.addEventListener('scroll', () => {
  ...
  // Als je bijna onderaan bent → forceer laatste section
